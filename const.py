...
_sintaxGraph={
    # IDENTIFICADORES
    TypeToken.TK_IDENTIFIER:[TypeToken.TK_PARENTHESESOPEN,TypeToken.TK_BRACKETSOPEN,TypeToken.TK_OPARROW,TypeToken.TK_OPDOT,TypeToken.TK_OPEOL,TypeToken.TK_OPTERNARYIF,TypeToken.TK_OPTERNARYELSE,TypeToken.TK_OPASSIGNMENT,TypeToken.TK_OPASUM,TypeToken.TK_OPASUB,TypeToken.TK_OPAMULT,TypeToken.TK_OPADIV,TypeToken.TK_OPAMOD,TypeToken.TK_OPALEFTSHIFT,TypeToken.TK_OPARIGHTSHIFT,TypeToken.TK_OPABITAND,TypeToken.TK_OPABITOR,TypeToken.TK_OPABITXOR,TypeToken.TK_OPAND,TypeToken.TK_OPOR,TypeToken.TK_OPNEGATION,TypeToken.TK_OPSUM,TypeToken.TK_OPSUB,TypeToken.TK_OPMULT,TypeToken.TK_OPDIV,TypeToken.TK_OPMOD,TypeToken.TK_OPINC,TypeToken.TK_OPDEC,TypeToken.TK_OPBITAND,TypeToken.TK_OPBITOR,TypeToken.TK_OPBITXOR,TypeToken.TK_OPBITCOMP,TypeToken.TK_OPBITLEFTSHIFT,TypeToken.TK_OPEOL],
    TypeToken.TK_INTEGER:[TypeToken.TK_OPEOL,TypeToken.TK_OPSUM,TypeToken.TK_OPSUB,TypeToken.TK_OPMULT,TypeToken.TK_OPDIV,TypeToken.TK_OPMOD,TypeToken.TK_OPINC,TypeToken.TK_OPDEC,TypeToken.TK_OPEQ,TypeToken.TK_OPNEQ,TypeToken.TK_OPLT,TypeToken.TK_OPGT,TypeToken.TK_OPGTEQ,TypeToken.TK_OPLTEQ],
    TypeToken.TK_FLOATINGPOINT:[TypeToken.TK_OPEOL,TypeToken.TK_OPSUM,TypeToken.TK_OPSUB,TypeToken.TK_OPMULT,TypeToken.TK_OPDIV,TypeToken.TK_OPMOD,TypeToken.TK_OPINC,TypeToken.TK_OPDEC,TypeToken.TK_OPEQ,TypeToken.TK_OPNEQ,TypeToken.TK_OPLT,TypeToken.TK_OPGT,TypeToken.TK_OPGTEQ,TypeToken.TK_OPLTEQ],
    TypeToken.TK_CHARLITERAL:[TypeToken.TK_OPEOL,TypeToken.TK_OPSUM,TypeToken.TK_OPSUB,TypeToken.TK_OPMULT,TypeToken.TK_OPDIV,TypeToken.TK_OPMOD,TypeToken.TK_OPINC,TypeToken.TK_OPDEC,TypeToken.TK_OPEQ,TypeToken.TK_OPNEQ,TypeToken.TK_OPLT,TypeToken.TK_OPGT,TypeToken.TK_OPGTEQ,TypeToken.TK_OPLTEQ],
    TypeToken.TK_STRINGLITERAL:[TypeToken.TK_OPEOL,TypeToken.TK_OPSUM,TypeToken.TK_OPSUB,TypeToken.TK_OPMULT,TypeToken.TK_OPDIV,TypeToken.TK_OPMOD,TypeToken.TK_OPINC,TypeToken.TK_OPDEC,TypeToken.TK_OPEQ,TypeToken.TK_OPNEQ,TypeToken.TK_OPLT,TypeToken.TK_OPGT,TypeToken.TK_OPGTEQ,TypeToken.TK_OPLTEQ],

    TypeToken.TK_OPHEAD:[TypeToken.TK_IDENTIFIER],
    # OPERADORES
    TypeToken.TK_OPEOL:[TypeToken.TK_IDENTIFIER,TypeToken.TK_BRACESCLOSE,TypeToken.TK_PARENTHESESCLOSE,TypeToken.TK_KWUNION,TypeToken.TK_KWENUM,TypeToken.TK_KWCHAR,TypeToken.TK_KWFLOAT,TypeToken.TK_KWSHORT,TypeToken.TK_KWINT,TypeToken.TK_KWDOUBLE,TypeToken.TK_KWLONG,TypeToken.TK_KWSIGNED,TypeToken.TK_KWUNSIGNED,TypeToken.TK_KWCONST,TypeToken.TK_KWRETURN],
    # ARITHMETICS
    TypeToken.TK_OPSUM:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPSUB:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPMULT:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPDIV:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPMOD:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    ...
    # ASSIGNMENT
    TypeToken.TK_OPASSIGNMENT:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPASUM:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPASUB:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPAMULT:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPADIV:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    TypeToken.TK_OPAMOD:[TypeToken.TK_IDENTIFIER,TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_CHARLITERAL,TypeToken.TK_STRINGLITERAL],
    ...
    # DELIMITADORES
    TypeToken.TK_PARENTHESESOPEN:[TypeToken.TK_KWCHAR,TypeToken.TK_KWFLOAT,TypeToken.TK_KWSHORT,TypeToken.TK_KWINT,TypeToken.TK_KWDOUBLE,TypeToken.TK_KWLONG,TypeToken.TK_KWSIGNED,TypeToken.TK_KWUNSIGNED,TypeToken.TK_KWCONST,TypeToken.TK_PARENTHESESCLOSE],
    TypeToken.TK_BRACESOPEN:[TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_IDENTIFIER,TypeToken.TK_KWCHAR,TypeToken.TK_KWFLOAT,TypeToken.TK_KWSHORT,TypeToken.TK_KWINT,TypeToken.TK_KWDOUBLE,TypeToken.TK_KWLONG,TypeToken.TK_KWSIGNED,TypeToken.TK_KWUNSIGNED,TypeToken.TK_KWCONST],
    TypeToken.TK_BRACKETSOPEN:[TypeToken.TK_INTEGER,TypeToken.TK_FLOATINGPOINT,TypeToken.TK_IDENTIFIER,],
    TypeToken.TK_PARENTHESESCLOSE:[TypeToken.TK_BRACESOPEN],
    TypeToken.TK_BRACKETSCLOSE:[],
    TypeToken.TK_BRACESCLOSE:[],
    # KEY WORDS
    ...
    TypeToken.TK_KWCHAR:[TypeToken.TK_IDENTIFIER,TypeToken.TK_OPMULT],
    TypeToken.TK_KWFLOAT:[TypeToken.TK_IDENTIFIER,TypeToken.TK_OPMULT],
    TypeToken.TK_KWSHORT:[TypeToken.TK_IDENTIFIER,TypeToken.TK_OPMULT],
    TypeToken.TK_KWINT:[TypeToken.TK_IDENTIFIER,TypeToken.TK_OPMULT],
    TypeToken.TK_KWDOUBLE:[TypeToken.TK_IDENTIFIER,TypeToken.TK_OPMULT],
    TypeToken.TK_KWLONG:[TypeToken.TK_IDENTIFIER,TypeToken.TK_OPMULT],
